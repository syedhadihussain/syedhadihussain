...
export const translations: Translations = {
  ...
  "pricing.fullStackSeoDesc": { en: "Complete local SEO solution with result guarantee. Includes website SEO, GBP management & 10 citations/month.", ar: "حل SEO محلي كامل مع ضمان النتائج. يشمل SEO الموقع وإدارة GBP و10 استشهادات/شهر.", es: "Solución SEO local completa con garantía de resultados. Incluye SEO del sitio web, gestión GBP y 10 citaciones/mes.", pt: "Solução SEO local completa com garantia de resultados. Inclui SEO do site, gestão GBP e 10 citações/mês.", fr: "Solution SEO locale complète avec garantie de résultats. Inclut SEO du site, gestion GBP et 10 citations/mois.", it: "Soluzione SEO locale completa con garanzia di risultati. Include SEO del sito, gestione GBP e 10 citazioni/mese.", de: "Komplette lokale SEO-Lösung mit Ergebnisgarantie. Beinhaltet Website-SEO, GBP-Verwaltung und 10 Zitationen/Monat." },
  "pricing.fullStackSeoFeaturedDesc": { en: "Result guaranteed or we work FREE after agreed timeline. We analyze your competition and set realistic ranking goals during the full business audit. Includes full website SEO, GBP management, 10 citations/month (no backlinks).", ar: "نتائج مضمونة أو نعمل مجاناً بعد الجدول الزمني المتفق عليه. نحلل منافسيك ونضع أهداف ترتيب واقعية أثناء التدقيق الكامل للأعمال. يشمل SEO كامل للموقع وإدارة GBP و10 استشهادات/شهر (بدون روابط خلفية).", es: "Resultado garantizado o trabajamos GRATIS después del plazo acordado. Analizamos tu competencia y establecemos objetivos de posicionamiento realistas durante la auditoría completa del negocio. Incluye SEO completo del sitio web, gestión GBP, 10 citaciones/mes (sin backlinks).", pt: "Resultado garantido ou trabalhamos GRÁTIS após o prazo acordado. Analisamos sua concorrência e definimos metas de ranking realistas durante a auditoria completa do negócio. Inclui SEO completo do site, gestão GBP, 10 citações/mês (sem backlinks).", fr: "Résultat garanti ou nous travaillons GRATUITEMENT après le délai convenu. Nous analysons votre concurrence et fixons des objectifs de classement réalistes lors de l'audit complet de l'entreprise. Inclut SEO complet du site, gestion GBP, 10 citations/mois (sans backlinks).", it: "Risultato garantito o lavoriamo GRATIS dopo la tempistica concordata. Analizziamo la tua concorrenza e stabiliamo obiettivi di posizionamento realistici durante l'audit aziendale completo. Include SEO completo del sito, gestione GBP, 10 citazioni/mese (senza backlink).", de: "Ergebnis garantiert oder wir arbeiten KOSTENLOS nach vereinbartem Zeitrahmen. Wir analysieren Ihre Konkurrenz und setzen realistische Ranking-Ziele während des vollständigen Geschäftsaudits. Beinhaltet vollständiges Website-SEO, GBP-Verwaltung, 10 Zitationen/Monat (keine Backlinks)." },
