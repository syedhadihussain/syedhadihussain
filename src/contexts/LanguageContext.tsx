...
export const translations: Translations = {
  ...
  "about.title": { en: "Your Expert Partner for Local SEO and Online Growth", ar: "شريكك الخبير لـ SEO المحلي والنمو عبر الإنترنت", es: "Tu Socio Experto en SEO Local y Crecimiento Online", pt: "Seu Parceiro Especialista em SEO Local e Crescimento Online", fr: "Votre Partenaire Expert pour le SEO Local et la Croissance en Ligne", it: "Il Tuo Partner Esperto per SEO Locale e Crescita Online", de: "Ihr Experten-Partner für lokales SEO und Online-Wachstum" },
  "about.description1": { en: "I help businesses grow online by helping them show up better in local search results. My focus is on bringing real customers, real calls, and real sales, not just website visitors. I carefully choose the best strategies that match your business needs, fit your budget, and support long-term growth.", ar: "أساعد الشركات على النمو عبر الإنترنت من خلال مساعدتها على الظهور بشكل أفضل في نتائج البحث المحلي. تركيزي على جلب عملاء حقيقيين ومكالمات حقيقية ومبيعات حقيقية، وليس مجرد زوار موقع. أختار بعناية أفضل الاستراتيجيات التي تتناسب مع احتياجات عملك وميزانيتك وتدعم النمو طويل المدى.", es: "Ayudo a las empresas a crecer en línea ayudándolas a aparecer mejor en los resultados de búsqueda local. Mi enfoque es traer clientes reales, llamadas reales y ventas reales, no solo visitantes del sitio web. Elijo cuidadosamente las mejores estrategias que coinciden con las necesidades de tu negocio, se ajustan a tu presupuesto y apoyan el crecimiento a largo plazo.", pt: "Ajudo empresas a crescer online ajudando-as a aparecer melhor nos resultados de busca local. Meu foco é trazer clientes reais, chamadas reais e vendas reais, não apenas visitantes do site. Escolho cuidadosamente as melhores estratégias que correspondem às necessidades do seu negócio, cabem no seu orçamento e apoiam o crescimento a longo prazo.", fr: "J'aide les entreprises à se développer en ligne en les aidant à mieux apparaître dans les résultats de recherche locale. Mon objectif est d'apporter de vrais clients, de vrais appels et de vraies ventes, pas seulement des visiteurs de site web. Je choisis soigneusement les meilleures stratégies qui correspondent aux besoins de votre entreprise, s'adaptent à votre budget et soutiennent la croissance à long terme.", it: "Aiuto le aziende a crescere online aiutandole a comparire meglio nei risultati di ricerca locale. Il mio focus è portare clienti reali, chiamate reali e vendite reali, non solo visitatori del sito. Scelgo con cura le migliori strategie che corrispondono alle esigenze della tua attività, si adattano al tuo budget e supportano la crescita a lungo termine.", de: "Ich helfe Unternehmen, online zu wachsen, indem ich ihnen helfe, besser in lokalen Suchergebnissen zu erscheinen. Mein Fokus liegt darauf, echte Kunden, echte Anrufe und echte Verkäufe zu bringen, nicht nur Website-Besucher. Ich wähle sorgfältig die besten Strategien aus, die zu Ihren Geschäftsanforderungen passen, in Ihr Budget passen und langfristiges Wachstum unterstützen." },
  "about.description2": { en: "Whether your project is small or large, I give you a clear and simple plan to improve your online presence, reach more local customers, and grow your business step by step.", ar: "سواء كان مشروعك صغيراً أو كبيراً، أقدم لك خطة واضحة وبسيطة لتحسين تواجدك عبر الإنترنت والوصول إلى المزيد من العملاء المحليين وتنمية عملك خطوة بخطوة.", es: "Ya sea que tu proyecto sea pequeño o grande, te doy un plan claro y simple para mejorar tu presencia en línea, llegar a más clientes locales y hacer crecer tu negocio paso a paso.", pt: "Seja seu projeto pequeno ou grande, dou a você um plano claro e simples para melhorar sua presença online, alcançar mais clientes locais e fazer seu negócio crescer passo a passo.", fr: "Que votre projet soit petit ou grand, je vous donne un plan clair et simple pour améliorer votre présence en ligne, atteindre plus de clients locaux et développer votre entreprise étape par étape.", it: "Che il tuo progetto sia piccolo o grande, ti do un piano chiaro e semplice per migliorare la tua presenza online, raggiungere più clienti locali e far crescere la tua attività passo dopo passo.", de: "Ob Ihr Projekt klein oder groß ist, ich gebe Ihnen einen klaren und einfachen Plan, um Ihre Online-Präsenz zu verbessern, mehr lokale Kunden zu erreichen und Ihr Geschäft Schritt für Schritt zu wachsen." },
  ...
  "about.processTitle": { en: "How I Work: Local SEO & Growth Process", ar: "كيف أعمل: عملية SEO المحلي والنمو", es: "Cómo Trabajo: Proceso de SEO Local y Crecimiento", pt: "Como Trabalho: Processo de SEO Local e Crescimento", fr: "Comment je Travaille: Processus SEO Local et Croissance", it: "Come Lavoro: Processo SEO Locale e Crescita", de: "Wie ich Arbeite: Lokaler SEO & Wachstumsprozess" },
  "about.process.step1Title": { en: "Understand Your Business & Local Market", ar: "فهم عملك والسوق المحلي", es: "Entender Tu Negocio y Mercado Local", pt: "Entender Seu Negócio e Mercado Local", fr: "Comprendre Votre Entreprise et Marché Local", it: "Comprendere la Tua Attività e il Mercato Locale", de: "Ihr Unternehmen & Lokalen Markt Verstehen" },
  "about.process.step1Desc": { en: "I analyze your goals, competitors, and local market trends to create a custom strategy for your business.", ar: "أحلل أهدافك ومنافسيك واتجاهات السوق المحلي لإنشاء استراتيجية مخصصة لعملك.", es: "Analizo tus objetivos, competidores y tendencias del mercado local para crear una estrategia personalizada para tu negocio.", pt: "Analiso seus objetivos, concorrentes e tendências do mercado local para criar uma estratégia personalizada para seu negócio.", fr: "J'analyse vos objectifs, concurrents et tendances du marché local pour créer une stratégie personnalisée pour votre entreprise.", it: "Analizzo i tuoi obiettivi, concorrenti e tendenze del mercato locale per creare una strategia personalizzata per la tua attività.", de: "Ich analysiere Ihre Ziele, Wettbewerber und lokale Markttrends, um eine maßgeschneiderte Strategie für Ihr Unternehmen zu erstellen." },
  "about.process.step2Title": { en: "Local SEO & Google Business Profile Optimization", ar: "تحسين SEO المحلي وGoogle Business Profile", es: "SEO Local y Optimización de Google Business Profile", pt: "SEO Local e Otimização do Google Business Profile", fr: "SEO Local et Optimisation Google Business Profile", it: "SEO Locale e Ottimizzazione Google Business Profile", de: "Lokales SEO & Google Business Profile Optimierung" },
  "about.process.step2Desc": { en: "I optimize your Google Business Profile, Google Maps, and other local listings to ensure your business appears first in local searches. This includes voice search, map rankings, reviews, and citations, so local customers find you before competitors.", ar: "أحسّن ملفك التجاري على Google وخرائط Google والقوائم المحلية الأخرى لضمان ظهور عملك أولاً في عمليات البحث المحلية. يشمل ذلك البحث الصوتي وتصنيفات الخرائط والمراجعات والاستشهادات، حتى يجدك العملاء المحليون قبل المنافسين.", es: "Optimizo tu Google Business Profile, Google Maps y otras listas locales para asegurar que tu negocio aparezca primero en las búsquedas locales. Esto incluye búsqueda por voz, rankings de mapas, reseñas y citaciones, para que los clientes locales te encuentren antes que a los competidores.", pt: "Otimizo seu Google Business Profile, Google Maps e outras listagens locais para garantir que seu negócio apareça primeiro nas buscas locais. Isso inclui busca por voz, rankings de mapas, avaliações e citações, para que clientes locais encontrem você antes dos concorrentes.", fr: "J'optimise votre Google Business Profile, Google Maps et autres listings locaux pour assurer que votre entreprise apparaît en premier dans les recherches locales. Cela inclut la recherche vocale, les classements sur les cartes, les avis et les citations, pour que les clients locaux vous trouvent avant les concurrents.", it: "Ottimizzo il tuo Google Business Profile, Google Maps e altre schede locali per garantire che la tua attività appaia per prima nelle ricerche locali. Questo include ricerca vocale, ranking su mappe, recensioni e citazioni, così i clienti locali ti trovano prima dei concorrenti.", de: "Ich optimiere Ihr Google Business Profile, Google Maps und andere lokale Einträge, um sicherzustellen, dass Ihr Unternehmen bei lokalen Suchen zuerst erscheint. Dies umfasst Sprachsuche, Kartenrankings, Bewertungen und Zitate, damit lokale Kunden Sie vor den Wettbewerbern finden." },
  "about.process.step3Title": { en: "Modern Website & Technical SEO", ar: "الموقع الحديث وSEO التقني", es: "Sitio Web Moderno y SEO Técnico", pt: "Site Moderno e SEO Técnico", fr: "Site Web Moderne et SEO Technique", it: "Sito Web Moderno e SEO Tecnico", de: "Moderne Website & Technisches SEO" },
  "about.process.step3Desc": { en: "I build websites with Next.js, React, and modern web standards. Your site will be fast, mobile-friendly, secure, and SEO-optimized, helping your business stand out locally and globally.", ar: "أبني مواقع ويب باستخدام Next.js وReact ومعايير الويب الحديثة. سيكون موقعك سريعاً ومتوافقاً مع الجوال وآمناً ومحسناً لـ SEO، مما يساعد عملك على التميز محلياً وعالمياً.", es: "Construyo sitios web con Next.js, React y estándares web modernos. Tu sitio será rápido, compatible con móviles, seguro y optimizado para SEO, ayudando a tu negocio a destacar local y globalmente.", pt: "Construo sites com Next.js, React e padrões web modernos. Seu site será rápido, compatível com dispositivos móveis, seguro e otimizado para SEO, ajudando seu negócio a se destacar local e globalmente.", fr: "Je construis des sites web avec Next.js, React et les standards web modernes. Votre site sera rapide, adapté aux mobiles, sécurisé et optimisé pour le SEO, aidant votre entreprise à se démarquer localement et mondialement.", it: "Costruisco siti web con Next.js, React e standard web moderni. Il tuo sito sarà veloce, mobile-friendly, sicuro e ottimizzato per SEO, aiutando la tua attività a distinguersi localmente e globalmente.", de: "Ich baue Websites mit Next.js, React und modernen Webstandards. Ihre Website wird schnell, mobilfreundlich, sicher und SEO-optimiert sein und Ihrem Unternehmen helfen, lokal und global hervorzustechen." },
  "about.process.step4Title": { en: "AI & Automation Integration", ar: "تكامل الذكاء الاصطناعي والأتمتة", es: "Integración de IA y Automatización", pt: "Integração de IA e Automação", fr: "Intégration IA et Automatisation", it: "Integrazione IA e Automazione", de: "KI & Automatisierungsintegration" },
  "about.process.step4Desc": { en: "I implement AI chatbots, AI receptionists, and lead automation systems to answer customers, capture leads, and improve engagement automatically.", ar: "أنفذ روبوتات دردشة ذكية وموظفي استقبال ذكاء اصطناعي وأنظمة أتمتة العملاء المحتملين للرد على العملاء والتقاط العملاء المحتملين وتحسين المشاركة تلقائياً.", es: "Implemento chatbots de IA, recepcionistas de IA y sistemas de automatización de leads para responder a clientes, capturar leads y mejorar el engagement automáticamente.", pt: "Implemento chatbots de IA, recepcionistas de IA e sistemas de automação de leads para responder clientes, capturar leads e melhorar o engajamento automaticamente.", fr: "J'implémente des chatbots IA, des réceptionnistes IA et des systèmes d'automatisation de leads pour répondre aux clients, capturer des leads et améliorer l'engagement automatiquement.", it: "Implemento chatbot IA, receptionist IA e sistemi di automazione lead per rispondere ai clienti, catturare lead e migliorare l'engagement automaticamente.", de: "Ich implementiere KI-Chatbots, KI-Rezeptionisten und Lead-Automatisierungssysteme, um Kunden zu antworten, Leads zu erfassen und das Engagement automatisch zu verbessern." },
  "about.process.step5Title": { en: "Advanced Marketing & Advertising", ar: "التسويق والإعلان المتقدم", es: "Marketing y Publicidad Avanzados", pt: "Marketing e Publicidade Avançados", fr: "Marketing et Publicité Avancés", it: "Marketing e Pubblicità Avanzati", de: "Fortgeschrittenes Marketing & Werbung" },
  "about.process.step5Desc": { en: "I create smart campaigns for Local Service Ads, Google Ads, Meta Ads, social media, and email marketing. Every campaign is data-driven and focused on results, helping you reach more customers and outperform competitors.", ar: "أنشئ حملات ذكية لإعلانات الخدمات المحلية وإعلانات Google وإعلانات Meta ووسائل التواصل الاجتماعي والتسويق عبر البريد الإلكتروني. كل حملة مدفوعة بالبيانات ومركزة على النتائج، مما يساعدك على الوصول إلى المزيد من العملاء والتفوق على المنافسين.", es: "Creo campañas inteligentes para Local Service Ads, Google Ads, Meta Ads, redes sociales y email marketing. Cada campaña está basada en datos y enfocada en resultados, ayudándote a alcanzar más clientes y superar a los competidores.", pt: "Crio campanhas inteligentes para Local Service Ads, Google Ads, Meta Ads, mídias sociais e email marketing. Cada campanha é baseada em dados e focada em resultados, ajudando você a alcançar mais clientes e superar concorrentes.", fr: "Je crée des campagnes intelligentes pour les Local Service Ads, Google Ads, Meta Ads, les réseaux sociaux et l'email marketing. Chaque campagne est basée sur les données et axée sur les résultats, vous aidant à atteindre plus de clients et à surpasser les concurrents.", it: "Creo campagne intelligenti per Local Service Ads, Google Ads, Meta Ads, social media ed email marketing. Ogni campagna è data-driven e focalizzata sui risultati, aiutandoti a raggiungere più clienti e superare i concorrenti.", de: "Ich erstelle intelligente Kampagnen für Local Service Ads, Google Ads, Meta Ads, Social Media und E-Mail-Marketing. Jede Kampagne ist datengesteuert und ergebnisorientiert und hilft Ihnen, mehr Kunden zu erreichen und Wettbewerber zu übertreffen." },
  "about.process.step6Title": { en: "Tracking, Analytics & Continuous Improvement", ar: "التتبع والتحليلات والتحسين المستمر", es: "Seguimiento, Analytics y Mejora Continua", pt: "Rastreamento, Analytics e Melhoria Contínua", fr: "Suivi, Analytics et Amélioration Continue", it: "Tracking, Analytics e Miglioramento Continuo", de: "Tracking, Analytics & Kontinuierliche Verbesserung" },
  "about.process.step6Desc": { en: "I monitor performance using GA4, Google Tag Manager, and custom tracking dashboards to measure results. I continuously optimize your campaigns and SEO so your business keeps growing.", ar: "أراقب الأداء باستخدام GA4 وGoogle Tag Manager ولوحات تتبع مخصصة لقياس النتائج. أحسّن حملاتك وSEO باستمرار حتى يستمر عملك في النمو.", es: "Monitoreo el rendimiento usando GA4, Google Tag Manager y dashboards de seguimiento personalizados para medir resultados. Optimizo continuamente tus campañas y SEO para que tu negocio siga creciendo.", pt: "Monitoro o desempenho usando GA4, Google Tag Manager e dashboards de rastreamento personalizados para medir resultados. Otimizo continuamente suas campanhas e SEO para que seu negócio continue crescendo.", fr: "Je surveille les performances en utilisant GA4, Google Tag Manager et des tableaux de bord de suivi personnalisés pour mesurer les résultats. J'optimise continuellement vos campagnes et SEO pour que votre entreprise continue de croître.", it: "Monitoro le prestazioni utilizzando GA4, Google Tag Manager e dashboard di tracking personalizzati per misurare i risultati. Ottimizzo continuamente le tue campagne e SEO affinché la tua attività continui a crescere.", de: "Ich überwache die Leistung mit GA4, Google Tag Manager und benutzerdefinierten Tracking-Dashboards, um Ergebnisse zu messen. Ich optimiere kontinuierlich Ihre Kampagnen und SEO, damit Ihr Unternehmen weiter wächst." },
  
  // Why Clients Choose Me
  "about.whyChooseTitle": { en: "Why Clients Choose Me", ar: "لماذا يختارني العملاء", es: "Por Qué los Clientes Me Eligen", pt: "Por Que os Clientes Me Escolhem", fr: "Pourquoi les Clients Me Choisissent", it: "Perché i Clienti Mi Scelgono", de: "Warum Kunden Mich Wählen" },
  "about.why.localSeoSpecialist": { en: "Local SEO Specialist: Help your business appear first on Google Search and Maps", ar: "متخصص SEO المحلي: أساعد عملك على الظهور أولاً على بحث Google والخرائط", es: "Especialista en SEO Local: Ayudo a tu negocio a aparecer primero en Google Search y Maps", pt: "Especialista em SEO Local: Ajudo seu negócio a aparecer primeiro no Google Search e Maps", fr: "Spécialiste SEO Local: J'aide votre entreprise à apparaître en premier sur Google Search et Maps", it: "Specialista SEO Locale: Aiuto la tua attività ad apparire per prima su Google Search e Maps", de: "Lokaler SEO-Spezialist: Ich helfe Ihrem Unternehmen, zuerst bei Google Search und Maps zu erscheinen" },
  "about.why.clearPractical": { en: "Clear & Practical: Every step explained, easy to understand", ar: "واضح وعملي: كل خطوة موضحة، سهلة الفهم", es: "Claro y Práctico: Cada paso explicado, fácil de entender", pt: "Claro e Prático: Cada passo explicado, fácil de entender", fr: "Clair et Pratique: Chaque étape expliquée, facile à comprendre", it: "Chiaro e Pratico: Ogni passo spiegato, facile da capire", de: "Klar & Praktisch: Jeder Schritt erklärt, leicht verständlich" },
  "about.why.bestFitSolutions": { en: "Best Fit Solutions: I suggest tools and strategies that work for your business, saving you money", ar: "حلول مناسبة: أقترح أدوات واستراتيجيات تعمل لعملك، موفراً لك المال", es: "Soluciones Adecuadas: Sugiero herramientas y estrategias que funcionan para tu negocio, ahorrándote dinero", pt: "Soluções Adequadas: Sugiro ferramentas e estratégias que funcionam para seu negócio, economizando dinheiro", fr: "Solutions Adaptées: Je suggère des outils et stratégies qui fonctionnent pour votre entreprise, vous faisant économiser", it: "Soluzioni Adatte: Suggerisco strumenti e strategie che funzionano per la tua attività, risparmiandoti denaro", de: "Passende Lösungen: Ich schlage Tools und Strategien vor, die für Ihr Unternehmen funktionieren und Ihnen Geld sparen" },
  "about.why.aiAutomation": { en: "AI & Automation: Smart systems to save time and improve customer engagement", ar: "الذكاء الاصطناعي والأتمتة: أنظمة ذكية لتوفير الوقت وتحسين تفاعل العملاء", es: "IA y Automatización: Sistemas inteligentes para ahorrar tiempo y mejorar el engagement", pt: "IA e Automação: Sistemas inteligentes para economizar tempo e melhorar o engajamento", fr: "IA et Automatisation: Systèmes intelligents pour gagner du temps et améliorer l'engagement client", it: "IA e Automazione: Sistemi intelligenti per risparmiare tempo e migliorare l'engagement", de: "KI & Automatisierung: Intelligente Systeme, um Zeit zu sparen und das Kundenengagement zu verbessern" },
  "about.why.scalable": { en: "Scalable for Any Project: Small or large projects are handled with the same care", ar: "قابل للتوسع لأي مشروع: المشاريع الصغيرة أو الكبيرة يتم التعامل معها بنفس العناية", es: "Escalable para Cualquier Proyecto: Proyectos pequeños o grandes manejados con el mismo cuidado", pt: "Escalável para Qualquer Projeto: Projetos pequenos ou grandes tratados com o mesmo cuidado", fr: "Évolutif pour Tout Projet: Les petits ou grands projets sont gérés avec le même soin", it: "Scalabile per Ogni Progetto: Progetti piccoli o grandi gestiti con la stessa cura", de: "Skalierbar für Jedes Projekt: Kleine oder große Projekte werden mit der gleichen Sorgfalt behandelt" },
  "about.why.futureReady": { en: "Future-Ready: Using the latest web technologies, AI tools, and SEO strategies", ar: "جاهز للمستقبل: استخدام أحدث تقنيات الويب وأدوات الذكاء الاصطناعي واستراتيجيات SEO", es: "Listo para el Futuro: Usando las últimas tecnologías web, herramientas de IA y estrategias SEO", pt: "Pronto para o Futuro: Usando as mais recentes tecnologias web, ferramentas de IA e estratégias SEO", fr: "Prêt pour l'Avenir: Utilisant les dernières technologies web, outils IA et stratégies SEO", it: "Pronto per il Futuro: Utilizzando le ultime tecnologie web, strumenti IA e strategie SEO", de: "Zukunftsbereit: Mit den neuesten Webtechnologien, KI-Tools und SEO-Strategien" },
  "about.why.endToEnd": { en: "End-to-End Support: From strategy to execution, I handle everything for measurable growth", ar: "دعم شامل: من الاستراتيجية إلى التنفيذ، أتولى كل شيء لنمو قابل للقياس", es: "Soporte de Principio a Fin: De la estrategia a la ejecución, manejo todo para un crecimiento medible", pt: "Suporte Completo: Da estratégia à execução, cuido de tudo para crescimento mensurável", fr: "Support de Bout en Bout: De la stratégie à l'exécution, je gère tout pour une croissance mesurable", it: "Supporto End-to-End: Dalla strategia all'esecuzione, gestisco tutto per una crescita misurabile", de: "End-to-End-Support: Von der Strategie bis zur Umsetzung kümmere ich mich um alles für messbares Wachstum" },
  ...
  "about.cert.localSeo": { en: "Local SEO Training", ar: "تدريب SEO المحلي", es: "Capacitación en SEO Local", pt: "Treinamento em SEO Local", fr: "Formation SEO Local", it: "Formazione SEO Locale", de: "Lokales SEO Training" },
  ...
  "about.expertise.localSeoGbp": { en: "Local SEO & GBP Optimization", ar: "SEO المحلي وتحسين GBP", es: "SEO Local y Optimización GBP", pt: "SEO Local e Otimização GBP", fr: "SEO Local et Optimisation GBP", it: "SEO Locale e Ottimizzazione GBP", de: "Lokales SEO & GBP-Optimierung" },
  "about.expertise.localSeoGbpDesc": { en: "Rank higher in local searches and maps", ar: "احتل مرتبة أعلى في عمليات البحث المحلية والخرائط", es: "Posiciónate más alto en búsquedas locales y mapas", pt: "Posicione-se mais alto em buscas locais e mapas", fr: "Classez-vous plus haut dans les recherches locales et les cartes", it: "Posizionati più in alto nelle ricerche locali e sulle mappe", de: "Ranken Sie höher in lokalen Suchen und Karten" },
  "about.expertise.voiceMapSeo": { en: "Voice Search & Map SEO", ar: "البحث الصوتي وSEO الخرائط", es: "Búsqueda por Voz y SEO de Mapas", pt: "Busca por Voz e SEO de Mapas", fr: "Recherche Vocale et SEO Maps", it: "Ricerca Vocale e SEO Mappe", de: "Sprachsuche & Karten-SEO" },
  "about.expertise.voiceMapSeoDesc": { en: "Google Maps, Apple Maps, Bing, voice-optimized search", ar: "خرائط Google وApple Maps وBing والبحث المحسن للصوت", es: "Google Maps, Apple Maps, Bing, búsqueda optimizada por voz", pt: "Google Maps, Apple Maps, Bing, busca otimizada por voz", fr: "Google Maps, Apple Maps, Bing, recherche optimisée pour la voix", it: "Google Maps, Apple Maps, Bing, ricerca ottimizzata per voce", de: "Google Maps, Apple Maps, Bing, sprachoptimierte Suche" },
  "about.expertise.webDev": { en: "Modern Website Development", ar: "تطوير المواقع الحديثة", es: "Desarrollo Web Moderno", pt: "Desenvolvimento Web Moderno", fr: "Développement Web Moderne", it: "Sviluppo Web Moderno", de: "Moderne Webentwicklung" },
  "about.expertise.webDevDesc": { en: "SEO-friendly, fast, mobile-optimized websites", ar: "مواقع صديقة لـ SEO وسريعة ومحسنة للجوال", es: "Sitios web SEO-friendly, rápidos y optimizados para móvil", pt: "Sites SEO-friendly, rápidos e otimizados para mobile", fr: "Sites web SEO-friendly, rapides et optimisés pour mobile", it: "Siti web SEO-friendly, veloci e ottimizzati per mobile", de: "SEO-freundliche, schnelle, mobiloptimierte Websites" },
  "about.expertise.aiChatbots": { en: "AI Chatbots & Assistants", ar: "روبوتات الدردشة والمساعدين الذكية", es: "Chatbots e Asistentes de IA", pt: "Chatbots e Assistentes de IA", fr: "Chatbots et Assistants IA", it: "Chatbot e Assistenti IA", de: "KI-Chatbots & Assistenten" },
  "about.expertise.aiChatbotsDesc": { en: "Capture leads and automate customer interactions", ar: "التقط العملاء المحتملين وأتمت تفاعلات العملاء", es: "Captura leads y automatiza interacciones con clientes", pt: "Capture leads e automatize interações com clientes", fr: "Capturez des leads et automatisez les interactions client", it: "Cattura lead e automatizza le interazioni con i clienti", de: "Erfassen Sie Leads und automatisieren Sie Kundeninteraktionen" },
  "about.expertise.automation": { en: "Automation & CRM Integration", ar: "الأتمتة وتكامل CRM", es: "Automatización e Integración CRM", pt: "Automação e Integração CRM", fr: "Automatisation et Intégration CRM", it: "Automazione e Integrazione CRM", de: "Automatisierung & CRM-Integration" },
  "about.expertise.automationDesc": { en: "Smart workflows for lead management and follow-ups", ar: "سير عمل ذكي لإدارة العملاء المحتملين والمتابعات", es: "Flujos de trabajo inteligentes para gestión de leads y seguimientos", pt: "Fluxos de trabalho inteligentes para gestão de leads e acompanhamentos", fr: "Workflows intelligents pour la gestion des leads et les suivis", it: "Workflow intelligenti per gestione lead e follow-up", de: "Intelligente Workflows für Lead-Management und Follow-ups" },
  "about.expertise.digitalMarketing": { en: "Digital Marketing & Ads", ar: "التسويق الرقمي والإعلانات", es: "Marketing Digital y Anuncios", pt: "Marketing Digital e Anúncios", fr: "Marketing Digital et Publicités", it: "Marketing Digitale e Pubblicità", de: "Digitales Marketing & Anzeigen" },
  "about.expertise.digitalMarketingDesc": { en: "Google Ads, Meta Ads, LSA campaigns, social media strategies", ar: "إعلانات Google وMeta Ads وحملات LSA واستراتيجيات وسائل التواصل", es: "Google Ads, Meta Ads, campañas LSA, estrategias de redes sociales", pt: "Google Ads, Meta Ads, campanhas LSA, estratégias de mídias sociais", fr: "Google Ads, Meta Ads, campagnes LSA, stratégies réseaux sociaux", it: "Google Ads, Meta Ads, campagne LSA, strategie social media", de: "Google Ads, Meta Ads, LSA-Kampagnen, Social-Media-Strategien" },
  "about.expertise.projectManagement": { en: "Project Management & Analytics", ar: "إدارة المشاريع والتحليلات", es: "Gestión de Proyectos y Analytics", pt: "Gerenciamento de Projetos e Analytics", fr: "Gestion de Projet et Analytics", it: "Gestione Progetti e Analytics", de: "Projektmanagement & Analytics" },
  "about.expertise.projectManagementDesc": { en: "Step-by-step strategy, measurable results", ar: "استراتيجية خطوة بخطوة، نتائج قابلة للقياس", es: "Estrategia paso a paso, resultados medibles", pt: "Estratégia passo a passo, resultados mensuráveis", fr: "Stratégie étape par étape, résultats mesurables", it: "Strategia passo dopo passo, risultati misurabili", de: "Schritt-für-Schritt-Strategie, messbare Ergebnisse" },
  "about.expertise.scalable": { en: "Scalable Strategies", ar: "استراتيجيات قابلة للتوسع", es: "Estrategias Escalables", pt: "Estratégias Escaláveis", fr: "Stratégies Évolutives", it: "Strategie Scalabili", de: "Skalierbare Strategien" },
  "about.expertise.scalableDesc": { en: "Local or global growth, small or large projects", ar: "نمو محلي أو عالمي، مشاريع صغيرة أو كبيرة", es: "Crecimiento local o global, proyectos pequeños o grandes", pt: "Crescimento local ou global, projetos pequenos ou grandes", fr: "Croissance locale ou globale, petits ou grands projets", it: "Crescita locale o globale, progetti piccoli o grandi", de: "Lokales oder globales Wachstum, kleine oder große Projekte" },
