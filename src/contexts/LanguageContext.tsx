...
export const translations: Translations = {
  ...
  "pricing.fullStackSeoDesc": { en: "Complete local SEO solution for businesses serious about dominating their market.", ar: "حل SEO محلي كامل للشركات الجادة في السيطرة على سوقها.", es: "Solución SEO local completa para empresas serias en dominar su mercado.", pt: "Solução SEO local completa para empresas sérias em dominar seu mercado.", fr: "Solution SEO locale complète pour les entreprises sérieuses qui veulent dominer leur marché.", it: "Soluzione SEO locale completa per aziende serie nel dominare il loro mercato.", de: "Komplette lokale SEO-Lösung für Unternehmen, die ihren Markt dominieren wollen." },
