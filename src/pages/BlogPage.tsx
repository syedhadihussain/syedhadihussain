...
const blogPosts = [
  {
    ...
    excerpt:
      "Learn how to fully optimize your Google Business Profile for maximum visibility and customer engagement. From verification to posts, this guide covers everything.",
  ...
  },
  {
    ...
    excerpt:
      "Discover how to find and prioritize local keywords that will drive qualified traffic and leads to your business. Includes tools and techniques.",
  ...
  },
  {
    ...
    excerpt:
      "NAP consistency is crucial for local rankings. Learn how to build and manage citations effectively across directories and aggregators.",
  ...
  },
  {
    ...
    excerpt:
      "Reviews impact both rankings and conversions. Learn strategies for generating more reviews and responding effectively to feedback.",
  ...
  },
  {
    ...
    excerpt:
      "A comprehensive checklist to identify and fix technical issues affecting your local search performance. Core Web Vitals, mobile optimization, and more.",
  ...
  },
  {
    ...
    excerpt:
      "How AI is transforming local search and what businesses need to do to stay ahead. SGE, AI overviews, and future-proofing your strategy.",
...
const BlogPage = () => {
  ...
  return (
    <>
      <SEOHead
        title={t("Local SEO Insights, Google Maps Tips & Growth Strategies – Syed Hadi Hussain")}
        description={t(
          "Actionable blog content covering Local SEO, Google Maps ranking, AI SEO, tracking, and advanced strategies for sustainable business growth."
        )}
            ...
            <div className="container-narrow text-center">
              <ScrollReveal animation="fade-up">
                ...
                <h1 className="font-display text-4xl lg:text-5xl font-bold text-foreground mb-6">
                  {t("Local SEO Insights & Strategies")}
                </h1>
              ...
              <ScrollReveal animation="scale">
                <div className="glass rounded-3xl p-12 glow">
                  <h2 className="font-display text-3xl font-bold text-foreground mb-4">
                    {t("Get Local SEO Tips in Your Inbox")}
                  </h2>
