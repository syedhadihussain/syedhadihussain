...
const caseStudies = [
  {
    ...
    challenge:
      "New phone repair business with zero online presence competing against established shops with years of reviews and local authority.",
    solution:
      "Comprehensive local SEO strategy including GBP optimization, aggressive citation building across 150+ directories, review generation campaign, and location-specific landing pages.",
    results: [
    ...
    testimonial:
      "Hadi took our business from invisible to #1 in Google Maps. We now get more calls than we can handle!",
  ...
  },
  {
    ...
    challenge:
      "Popular local restaurant was missing out on thousands of potential customers due to poor Google visibility despite excellent food and service.",
    solution:
      "GBP optimization with menu integration, restaurant schema markup, high-volume keyword targeting, and professional photo strategy.",
    results: [
    ...
    testimonial:
      "We went from page 3 to the top 3 map pack results. Reservations from Google have more than doubled!",
  ...
  },
  {
    ...
    challenge:
      "Low visibility in local search results for dental services, minimal online presence despite quality patient care.",
    solution:
      "Complete GBP optimization, local content strategy targeting dental keywords, citation building in healthcare directories.",
    results: [
    ...
    testimonial:
      "Hadi transformed our online presence. We went from invisible to dominating local search for dental services.",
  ...
  },
  {
    ...
    location: "London, UK",
    challenge:
      "Competing against established competitors with stronger online presence and more reviews in the plumbing niche.",
    solution:
      "Aggressive local SEO campaign, review generation with automated follow-up, technical website optimization.",
    results: [
    ...
    testimonial:
      "The ROI has been incredible. Every pound spent on SEO has returned tenfold. Highly recommend Hadi!",
  ...
  },
  {
    ...
    location: "Dubai, UAE",
    challenge:
      "Breaking into a competitive luxury market in Dubai with established players dominating search results.",
    solution:
      "Premium content strategy targeting luxury keywords, high-authority backlink building, comprehensive GBP optimization.",
    results: [
    ...
    testimonial:
      "We're now considered one of the top kitchen design firms in Dubai thanks to our improved online presence.",
  ...
  },
  {
    ...
    challenge:
      "Emergency locksmith business needed to capture high-intent searches from people locked out at all hours.",
    solution:
      "Optimized for emergency and 24/7 keywords, fast-loading mobile site, call tracking implementation, service area expansion.",
    results: [
    ...
    testimonial:
      "Our phone rings constantly now. Hadi understood the urgency of our business and optimized accordingly.",
  ...
  },
  {
    ...
    location: "Miami, USA",
    challenge:
      "New medical spa in competitive Miami market needed to establish authority and attract high-value clients.",
    solution:
      "Premium positioning strategy, service-specific landing pages, review generation for trust building, before/after gallery optimization.",
    results: [
  ...
  },
  {
    ...
    challenge:
      "Auto detailing business in saturated market needed to stand out and attract luxury car owners.",
    solution:
      "Niche keyword targeting for luxury vehicles, portfolio gallery optimization, GBP posts showcasing work quality.",
    results: [
    ...
    testimonial:
      "We now attract exactly the type of clients we want - luxury car owners who value quality work.",
...
const CaseStudiesPage = () => {
  ...
  return (
    <>
      <SEOHead
        title={t("Local SEO Case Studies Showing Google Maps Ranking Wins – Syed Hadi Hussain")}
        description={t(
          "In-depth Local SEO case studies explaining how businesses increased calls, leads, and Google Maps visibility using structured, scalable SEO strategies."
        )}
                    ...
                    <div className="p-6 lg:p-8">
                      ...
                      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                        {study.results.map((result) => (
                          ...
                          >
                            ...
                            <div className="text-xs font-medium text-foreground">{t(result.metric)}</div>
                            <div className="text-xs text-muted-foreground mt-1">{t(result.description)}</div>
                          </div>
                        ))}
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-6">
                        {study.features.map((feature) => (
                          <span
                            key={feature}
                            className="flex items-center gap-1 px-3 py-1.5 bg-secondary/50 rounded-full text-xs text-muted-foreground"
                          >
