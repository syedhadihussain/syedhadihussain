        ...
        <div className="max-w-4xl mx-auto">
          <div className="glass rounded-3xl p-8 lg:p-12 relative overflow-hidden">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">As a Local SEO specialist, I help businesses get more visibility, leads, and sales online. Beyond that, you can also hire me as your full-stack project manager to manage everything, so your business grows smoothly without juggling multiple vendors.</p>
            </div>

            {/* Capabilities */}
            <div className="flex flex-wrap justify-center gap-3 mb-8">
              {capabilities.map((cap, index) => <div key={index} className="flex items-center gap-2 px-4 py-2 bg-secondary/50 rounded-full text-sm text-foreground">
